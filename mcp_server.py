...
def hardware_spec(
    ...
    """
    from src.utils import GPUController, MultiGPUController, get_gpu_count
...
def analyze(
    ...
    from src.modes import AnalyzeMode
...
def compare(
    ...
    """
    from src.config import KernelType, KernelEvalConfig
    from src.modes import CompareMode
...
def configure_gpu(
    ...
    """
    from src.utils import MultiGPUController, MultiGPUConfig, GPUConfig
